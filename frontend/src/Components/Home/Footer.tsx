      ...
      <div className="flex flex-col md:flex-row justify-between items-start text-gray-700 font-sans">
        ...
        <div className="flex-1 md:pl-16 mt-8 md:mt-0">
          ...
          <div className="flex space-x-4 items-center">
            <img src="/assets/mastercard.png" alt="mastercard" className="w-10 h-6 object-contain" />
            <img src="/assets/visa.png" alt="visa" className="w-10 h-6 object-contain" />
            <img src="/assets/amex.png" alt="amex" className="w-10 h-6 object-contain" />
            <img src="/assets/paypal.png" alt="paypal" className="w-10 h-6 object-contain" />
            <img src="/assets/gcash.png" alt="gcash" className="w-10 h-6 object-contain" />
